      ...
      <div className="flex h-screen">
        ...
        <div className="hidden lg:flex lg:relative z-40 w-80 bg-slate-800/50 backdrop-blur-md border-r border-slate-700/50 flex-col h-full">
          ...
          <div className="flex-1 p-6 space-y-6 overflow-y-auto scrollbar-hidden">
            {/* Enhanced Emergency Numbers Section - Matching App Design */}
              ...
              <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-xl p-3 border border-slate-600/30 backdrop-blur-sm">
                <div className="space-y-2">
                  ...
                  <div className="group">
                    <button
                      onClick={() => window.open("tel:911", "_self")}
                      className="w-full text-left rounded-xl py-3 px-4 flex items-center gap-3 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 shadow-lg text-white font-semibold transition-all duration-200 hover:shadow-xl hover:shadow-red-500/25"
                    >
                      ...
                      <span className="text-sm flex-1">{t("emergency.call911")}</span>
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        <Phone className="w-3 h-3" />
                      </div>
                    </button>
                    <p className="text-xs text-slate-400 mt-1 ml-7">National emergency hotline</p>
                  </div>
                  ...
                  <div className="group">
                    <button
                      onClick={() => window.open("tel:143", "_self")}
                      className="w-full text-left rounded-xl py-3 px-4 flex items-center gap-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 shadow-lg text-white font-semibold transition-all duration-200 hover:shadow-xl hover:shadow-blue-500/25"
                    >
                      <Heart className="w-4 h-4" />
                      <span className="text-sm flex-1">{t("emergency.call143")}</span>
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        <Phone className="w-3 h-3" />
                      </div>
                    </button>
                    <p className="text-xs text-slate-400 mt-1 ml-7">Philippine Red Cross hotline</p>
                  </div>
                  ...
                  <div className="group">
                    <button
                      onClick={() => window.open("tel:117", "_self")}
                      className="w-full text-left rounded-xl py-3 px-4 flex items-center gap-3 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 shadow-lg text-white font-semibold transition-all duration-200 hover:shadow-xl hover:shadow-orange-500/25"
                    >
                      <Shield className="w-4 h-4" />
                      <span className="text-sm flex-1">{t("emergency.call117")}</span>
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        <Phone className="w-3 h-3" />
                      </div>
                    </button>
                    <p className="text-xs text-slate-400 mt-1 ml-7">Police and public safety hotline</p>
                  </div>
                </div>
              </div>
            </div>
