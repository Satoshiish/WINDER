    ...
    <div className="min-h-screen dark-dashboard text-white">
      ...
      {emergencyModalOpen && (
        <Dialog open={emergencyModalOpen} onOpenChange={setEmergencyModalOpen}>
          <DialogContent className="w-[90vw] h-[60vh] sm:!w-[40vw] sm:!h-[20vh] bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 text-white max-w-2xl flex flex-col">
            <DialogHeader className="flex-shrink-0">
