    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      <div className="flex h-screen">
              ...
              <div className="grid grid-cols-6 gap-1 p-2">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setTimeout(() => window.open("tel:143", "_self"), 1000)
                    setTimeout(() => window.open("tel:117", "_self"), 2000)
                  }}
                >
        ...
        <div className="hidden lg:flex lg:relative z-40 w-80 bg-slate-800/50 backdrop-blur-md border-r border-slate-700/50 flex-col h-full">
          ...
          {/* Scrollable Content */}
          <div className="flex-1 p-3 sm:p-6 space-y-3 sm:space-y-6 overflow-y-auto scrollbar-hidden">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                <button
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-red-600/20 to-red-500/20 hover:from-red-600/30 hover:to-red-500/30 
                  border border-red-500/40 rounded-lg sm:rounded-xl text-white font-semibold transition-all duration-200 flex items-center gap-2 sm:gap-3
                  shadow-lg shadow-red-500/10 hover:shadow-red-500/20 group"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-tr from-red-600 to-red-500 rounded-lg flex items-center justify-center flex-shrink-0
                  group-hover:scale-110 transition-transform">
                    <Phone className="w-4 h-4 text-white" />
                  </div>
                  <div className="text-left min-w-0">
                    <div className="font-bold text-red-400 text-sm sm:text-base">911</div>
                    <div className="text-xs text-slate-400 hidden sm:block">National emergency hotline</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-blue-600/20 to-blue-500/20 hover:from-blue-600/30 hover:to-blue-500/30 
                  border border-blue-500/40 rounded-lg sm:rounded-xl text-white font-semibold transition-all duration-200 flex items-center gap-2 sm:gap-3
                  shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 group"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-tr from-blue-600 to-blue-500 rounded-lg flex items-center justify-center flex-shrink-0
                  group-hover:scale-110 transition-transform">
                    <Phone className="w-4 h-4 text-white" />
                  </div>
                  <div className="text-left min-w-0">
                    <div className="font-bold text-blue-400 text-sm sm:text-base">143</div>
                    <div className="text-xs text-slate-400 hidden sm:block">Philippine Red Cross hotline</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-orange-600/20 to-orange-500/20 hover:from-orange-600/30 hover:to-orange-500/30 
                  border border-orange-500/40 rounded-lg sm:rounded-xl text-white font-semibold transition-all duration-200 flex items-center gap-2 sm:gap-3
                  shadow-lg shadow-orange-500/10 hover:shadow-orange-500/20 group"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-tr from-orange-600 to-orange-500 rounded-lg flex items-center justify-center flex-shrink-0
                  group-hover:scale-110 transition-transform">
                    <Phone className="w-4 h-4 text-white" />
                  </div>
                  <div className="text-left min-w-0">
                    <div className="font-bold text-orange-400 text-sm sm:text-base">117</div>
                    <div className="text-xs text-slate-400 hidden sm:block">Police and public safety hotline</div>
                  </div>
                </button>
              </div>
            </div>
