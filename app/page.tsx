    ...
    <div className="min-h-screen dark-dashboard text-white">
          ...
          <div className="lg:hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm">
            <div className="fixed inset-x-0 top-0 bg-gradient-to-r from-slate-900/95 to-slate-800/95 backdrop-blur-md border-b border-slate-700/50 p-6">
              ...
              <Button
                ...
                className="w-full mt-1 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-medium py-1.5 rounded-xl shadow-lg shadow-green-500/25 transition-all duration-200"
              >
      ...
      {emergencyModalOpen && (
        <Dialog open={emergencyModalOpen} onOpenChange={setEmergencyModalOpen}>
          <DialogContent className="w-[90vw] h-[35vh] sm:!w-[40vw] sm:!h-[40vh] bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700 text-white max-w-2xl flex flex-col">
            <DialogHeader className="flex-shrink-0">
